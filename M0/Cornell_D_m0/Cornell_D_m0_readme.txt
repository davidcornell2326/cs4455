...
To reach the top of the left ramp, you must jump the ball onto the top left platform (I recommend a rolling-start in sprint mode) and then use sprint mode to get up the steeper slope.
